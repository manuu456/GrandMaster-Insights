  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Chess.AI custom colors
        chess: {
          light: "hsl(var(--chess-board-light))",
          dark: "hsl(var(--chess-board-dark))",
      ...
      animation: {
        ...
        "chess-move": "chess-move 3s ease-in-out infinite",
        "fade-in-up": "fade-in-up 0.6s ease-out",
        "scale-bounce": "scale-bounce 0.3s ease-out",
        "chess-glow": "chess-glow 2s ease-in-out infinite",
      },
    },
  },
